...
public class CommandMessage extends Message {
	...
	public CommandMessage(Device device, String id, byte flag, byte type, byte[] data) {
		super(device);
		this.id = id;
		this.flag = flag;
		this.type = type;
	...
	public CommandMessage(Device device, String id, byte flag, byte type, String data) {
		this(device, id, flag, type, Converter.hexStringToByteArray(data));
	}
